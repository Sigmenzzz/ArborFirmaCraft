...
def generate(rm: ResourceManager):
    ...
    for wood in WOODS.keys():
        ...
        rm.crafting_shaped('crafting/wood/%s_wine_shelf' % wood, ['XYX', 'XYX', 'XYX'], {'X': 'afc:wood/log/%s' % wood, 'Y': 'firmalife:treated_lumber'}, '4 afc:wood/wine_shelf/%s' % wood)
        damage_shapeless(rm, 'crafting/wood/%s_stomping_barrel' % wood, ('#tfc:saws', 'afc:wood/barrel/%s' % wood), 'afc:wood/stomping_barrel/%s' % wood).with_advancement('tfc:wood/barrel/%s' % wood)
        rm.crafting_shapeless('crafting/wood/%s_barrel_press' % wood, ('afc:wood/stomping_barrel/%s' % wood, '#forge:rods/wrought_iron', '#forge:sheets/wrought_iron', 'tfc:brass_mechanisms'), 'afc:wood/barrel_press/%s' % wood)
        rm.crafting_shaped('crafting/wood/%s_keg' % wood, ['XYX', 'YZY', 'XYX'], {'X': 'afc:wood/log/%s' % wood, 'Y': 'firmalife:barrel_stave', 'Z': 'tfc:glue'}, 'afc:wood/big_barrel/%s' % wood).with_advancement('tfc:wood/log/%s' % wood)
